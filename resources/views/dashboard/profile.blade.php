@php
        $authUser = auth()->user();
        $name  =  $authUser -> last_name . ', ' . auth()->user()->first_name;
                ...
                <div class="w-full  mt-10  flex items-center justify-center flex-col p-5">
                    ...
                    <div class="w-full  flex items-center justify-center flex-col ">
                        ...
                        <div class="mt-2 flex items-center flex-col">
                            ...
                            <a href="{{route('auth.changePassword', $authUser->id)}}"   class="btn btn-primary mt-2 text-white" >Change Password</a>
                        </div>
                    </div>
                </div>
            </div>
