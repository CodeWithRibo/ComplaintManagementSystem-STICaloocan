    ...
    <x-admin.navigation-bar>
        <x-Section>
            <div class="flex flex-col bg-white shadow-md rounded-md px-5 py-5 mt-20 mx-10"
                ...
                <h1 class="text-base-content text-2xl p-2 my-5 text-center xl:text-start border-l-4 border-primary bg-base-100 shadow-sm rounded-r-lg w-auto xl:w-96">Archived Complaints</h1>
                @include('Components.admin.complaint-table',
                               ['complaints' => $archived,
                                'resolutionNote' => null,
                                'noComplaintFound' => 'No archived complaints available'
                                 ])
                {{--Modal View Details--}}
