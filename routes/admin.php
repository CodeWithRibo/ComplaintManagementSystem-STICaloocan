...
Route::middleware(['admin.auth'])->group(function () {
    ...
    Route::get('/user-profile/{user}', [UserManagementController::class, 'showUserProfile'])->name('admin.show-user-profile');
    Route::put('/user-profile/{user}', [UserManagementController::class, 'editUserProfile'])->name('admin.user-profile');
    // ----------------------------- Overview & Reports --------------------------//
